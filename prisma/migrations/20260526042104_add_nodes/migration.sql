/*
  ...
  - A unique constraint covering the columns `[id,userId]` on the table `Workflow` will be added. If there are existing duplicate values, this will fail.
...
*/
-- CreateEnum
CREATE TYPE "NodeType" AS ENUM ('INITIAL', 'ACTION');
